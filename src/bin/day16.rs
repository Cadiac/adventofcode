...
fn find_possible_fields(tickets: &Vec<Vec<u64>>, fields: &Vec<Field>, fields_count: usize) -> Vec<(usize, String)> {
...
fn part_2(input: &str) -> u64 {
    ...
    return departure_values.iter().product();
}
