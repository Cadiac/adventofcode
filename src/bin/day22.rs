...
fn part_1(input: &str, bounds: Region) -> usize {
    ...
    let mut cubes: HashSet<(i64, i64, i64)> = HashSet::with_capacity(max_size as usize);
...
fn part_2(input: &str) -> usize {
    ...
    for line in input.lines() {
        ...
        let cuboid = Cuboid::new(x_min, x_max + 1, y_min, y_max + 1, z_min, z_max + 1);
...
mod tests {
    ...
    #[test]
    fn it_solves_part1_large_example_with_part2() {
        assert_eq!(
            part_2(
                "on x=-20..26,y=-36..17,z=-47..7\n\
                 on x=-20..33,y=-21..23,z=-26..28\n\
