...
fn main() -> () {
    let part1_program_result = part_1(String::from("./inputs/day02.txt"));
    let part2_program_result = part_2(String::from("./inputs/day02.txt"));
...
mod tests {
    ...
    #[test]
    fn it_solves_part2() {
        assert_eq!(part_2(String::from("./inputs/day02.txt")), 8444);
    }
}
